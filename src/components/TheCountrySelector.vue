<template>
    <div>
        ...
        <button @click="handleClick">{{selectButtonText}}</button>
    </div>
</template>

<script>
    export default {
        name: "the-country-selector",
        methods: {
            handleClick() {
        ...
        data: () => {
            return {
                ...
                countries: [
                    ...
                    {value: "Congo, the Democratic Republic of", text: "Congo, the Democratic Republic of"},
                    ...
                    {value: "United Kingdom of Great Britain and Northern Ireland", text: "United Kingdom of Great Britain and Northern Ireland"},
                    ...
                    {value: "Heard Island and McDonalds Islands", text: "Heard Island and McDonalds Islands"},
